...
puts "================"
puts "require <file> actually runs the file within the script. If you want a file in the same directory './filename'"
puts "================"
puts "Puts adds a new line at the end of the output and print does not."