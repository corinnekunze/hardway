...
5. Your boolean tests should be simple. If they are complex, move their calculations to variables either in your function and use a good name for the variable.
